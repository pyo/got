...
<?php 
	...
	if ($vid) {
		...
		echo '<div data-video-wrapper><div data-video="vevo" data-video-width="" data-video-height="" class="video featured-video" style="position:relative;"><img src="' . get_template_directory_uri() . '/img/got_vid_logo.png" style="position:absolute;right:1.4em; bottom:1.4em;margin:0;"><a href="#" onclick="return false;" class="play_button"></a>';
