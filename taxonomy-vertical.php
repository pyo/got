...
<div class="row" id="bg_wrapper">
	<div class="sixteen columns" id="primary">
		<?php $current_tax = $wp_query->query_vars['term']; ?>
		<?php $current_tax = get_term($wp_query->queried_object_id, 'vertical', ARRAY_A); ?>
		<div class="banner-wrapper">
			<h3 class="header-banner no-margin-top"><span class="latest_icon"></span> <?php if ($current_tax) { echo $current_tax['name']; } else { echo 'The Latest'; } ?></h3>
		</div>
		<div class="row">
