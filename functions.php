<?php
	...
	function script_enqueuer() {
		...
		if(!is_admin()){
			...
			wp_enqueue_script( 'mustache', get_template_directory_uri() . '/javascripts/mustache.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_script('site', get_template_directory_uri() . '/javascripts/site.uglify.min.js', array('jquery', 'mustache'), '1.0', true);
